package lib.viewpagerindicator.normal;
...
//	Typeface font;
	...
	List<OnPageChangeListener> pageChangeListeners = new CopyOnWriteArrayList<OnPageChangeListener>();
...
//		if (font == null)
//			font = FontUtil.getInstance(getContext()).getDefaultFont();
		...
		currentParams.addRule(RelativeLayout.CENTER_IN_PARENT);
...
//		mPrevious.setTypeface(font, Typeface.NORMAL);
//		mCurrent.setTypeface(font, Typeface.BOLD);
//		mNext.setTypeface(font, Typeface.NORMAL);
	...
	public void addPageChangeListener(OnPageChangeListener listener) {
		if (pageChangeListeners == null)
			pageChangeListeners = new CopyOnWriteArrayList<OnPageChangeListener>();
