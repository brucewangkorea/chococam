...
public class FacebookUtility extends Application {
    ...
    public static String profilePhotoUrl = null;
    ...
    /*
     * 우리 앱의 아이콘 URL을 지정하면 됩니다.
     */
    public static String m_faebook_app_icon_url = "https://fbcdn-photos-a.akamaihd.net/photos-ak-snc7/v85005/186/148226865310626/app_1_148226865310626_1528519066.gif";//https://trello-avatars.s3.amazonaws.com/5756f99f0a57a8e21d25d19f2a6c9275/170.png";
    public static String getAppIconUrl(){
    	return m_faebook_app_icon_url;
    }
    public static void setetAppIconUrl(String url){
    	m_faebook_app_icon_url = url;
    }
